...
<table >
    ...
    <tr>
        <td colspan="3">
            <textarea style="padding:15px;" id="inputTextToSave" cols="45" rows="25"></textarea>
        </td>
    </tr>
    <tr>
...
<p style="font-weight:bold; font-size:1.2em; color:#000;">Dați click pe imagine pentru a o imprima</p>
 <p><img src="images/schita.png" alt="cannot load" style="max-width:100%;" onClick="printme(event)"></p>
 </div>
</div>
<br>
</div><!-- main -->
